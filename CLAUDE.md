...
- `docs/search_index_unify.md` — **검색 통일 (2026-08-08 구현 완료)**. 다섯 그릇을 모두 SQLite 색인으로 모은 6단계 계획과 그 결과. 앞선 웹 설계문서의 전제 반증 근거, 두 글자 우회가 필수인 이유, 첨부 기록 그릇 몫(9장)을 담았다 — 검색 관련 작업 전 반드시 읽을 것
