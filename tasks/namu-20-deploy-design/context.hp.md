...
## 지금 어디까지
- #20 커밋·푸시까지 전부 종료(1b3aecf·a67dca6·4297afa, log [완료] 21:53 참조). 후속 별건이던 설치형 사용설명서는 #23으로 완료(2026-07-08), 영어 README만 잔여
- (2026-07-08 정정) ▶ 다음의 "(완료)+뒷말"이 완료 판정(정확 일치)에 안 걸려 statusLine 유령 노출 → 규약대로 (완료) 단독 정정 [samsung]
