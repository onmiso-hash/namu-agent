---
name: namu-update
description: 다중호스트(claude, agy, grok) 원클릭 업데이트. /namu:update로 명시 호출하거나 사용자가 플러그인을 최신 버전으로 업데이트 해달라고 할 때 사용.
---
...
Claude Code, agy(Antigravity CLI), Grok을 지원하며 설치된 호스트를 자동 감지해 업데이트를 수행한다.
